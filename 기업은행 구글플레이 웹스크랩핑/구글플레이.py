...
# review link link
link = 'https://play.google.com/store/apps/details?id=com.ibk.scbs&showAllReviews=true'
...
for i in range(scroll_cnt):
    ...
    try:
        load_more = driver.find_element_by_xpath("/html/body/div[1]/div[4]/c-wiz[3]/div/div[2]/div/div/main/div/div[1]/div[2]/div[2]/div/span/span").click()
    except:
